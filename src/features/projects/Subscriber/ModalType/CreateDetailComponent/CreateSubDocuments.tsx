...
const CreateSubDocuments: React.FC<CreateDetailsProps> = ({ id, handleAccordionToggle, accordion }) => {
  ...
  return (
    ...
    <Accordion title="Subscriber Document" isOpen={accordion === "document"} toggleAccordion={() => handleAccordionToggle("document")}>
...
export default CreateSubDocuments;

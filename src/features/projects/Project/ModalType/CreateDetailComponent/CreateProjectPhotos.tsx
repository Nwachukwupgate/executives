...
const CreateProjectPhoto: React.FC<CreateDetailsProps> = ({ id, handleAccordionToggle, accordion }) => {
  ...
  return (
    ...
    <Accordion title="Project Photos" isOpen={accordion === "photos"} toggleAccordion={() => handleAccordionToggle("photos")}>
...
export default CreateProjectPhoto;

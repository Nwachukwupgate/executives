...
const CreateProjectAmenities: React.FC<CreateDetailsProps> = ({ id, handleAccordionToggle, accordion }) => {
  ...
  return (
    ...
    <Accordion title="Project Amenities" isOpen={accordion === "amenities"} toggleAccordion={() => handleAccordionToggle("amenities")}>
      {/* <h2 className="text-lg font-semibold">Project Amenities</h2> */}
